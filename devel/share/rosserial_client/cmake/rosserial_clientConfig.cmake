...
if(TRUE)
  set(rosserial_client_SOURCE_PREFIX /home/joseph/catkin_ws/src/rosserial/rosserial_client)
  set(rosserial_client_DEVEL_PREFIX /home/joseph/catkin_ws/devel)
  ...
  set(rosserial_client_INSTALL_PREFIX /home/joseph/catkin_ws/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /home/joseph/catkin_ws/src/rosserial/rosserial_client/${idir})
      set(include /home/joseph/catkin_ws/src/rosserial/rosserial_client/${idir})
    else()
      message(FATAL_ERROR "Project 'rosserial_client' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joseph/catkin_ws/src/rosserial/rosserial_client/${idir}'.  Ask the maintainer 'Michael Ferguson <mferguson@willowgarage.com>' to fix it.")
    endif()
