...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    ...
    elseif(IS_DIRECTORY /home/joseph/catkin_ws/install/${idir})
      ...
      message(FATAL_ERROR "Project 'rosserial_client' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joseph/catkin_ws/install/${idir}'.  Ask the maintainer 'Michael Ferguson <mferguson@willowgarage.com>' to fix it.")
    endif()
