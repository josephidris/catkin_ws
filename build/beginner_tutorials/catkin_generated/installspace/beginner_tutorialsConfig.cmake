...
if(NOT "/home/joseph/catkin_ws/install/include" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    ...
    elseif(IS_DIRECTORY /home/joseph/catkin_ws/install/${idir})
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joseph/catkin_ws/install/${idir}'.  Ask the maintainer 'joseph <joseph@todo.todo>' to fix it.")
    endif()
